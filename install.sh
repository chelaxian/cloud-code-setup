...
clear
echo -e "${CYAN}════════════════════════════════════════════════════════════════════════════════${RESET}"
echo -e "${CYAN}   ____ _     ____ _____ ____  ___  ____     ____ _   _ ____ _____ ____  ${RESET}"
echo -e "${CYAN}  / ___| |   / ___|_   _|  _ \|_ _| __ )   / ___| | | / ___|_   _|  _ \ ${RESET}"
echo -e "${CYAN} | |   | |   \___ \ | | | |_) || ||  _ \  | |   | | | \___ \ | | | | | |${RESET}"
echo -e "${CYAN} | |___| |___ ___) || | |  _ < | || |_) | | |___| |_| |___) || | | |_| |${RESET}"
echo -e "${CYAN}  \____|_____|____/ |_| |_| \_\___|____/   \____|\___/|____/ |_| |____/ ${RESET}"
echo -e "${CYAN}${RESET}"
